...
const TRANSLATIONS = [
    'en' => [
        ...
        'group_jetbackup' => 'DirectAdmin / JetBackup',
        'da_api_url_label' => 'DirectAdmin API URL',
        'da_api_url_help' => "Base URL of this server's DirectAdmin panel, e.g. https://server.example.com:2222.",
        'da_admin_username_label' => 'DirectAdmin admin/reseller username',
        'da_admin_username_help' => "A DirectAdmin account (admin or reseller level) used to list hosting accounts and trigger JetBackup jobs via its Login Key.",
        'da_login_key_label' => 'DirectAdmin Login Key',
        'da_login_key_help' => 'A Login Key generated under DirectAdmin -> Login Keys for the account above.',
        'da_self_username_label' => "This app's own DirectAdmin username",
        'da_self_username_help' => 'The DirectAdmin account woo-managment itself runs under, used only for its own "Run backup now" button on Admin -> Backups.',
        'backups' => 'Backups',
    ...
    'fa' => [
        ...
        'group_jetbackup' => 'دایرکت‌ادمین / جت‌بکاپ',
        'da_api_url_label' => 'آدرس API دایرکت‌ادمین',
        'da_api_url_help' => 'آدرس پایه پنل دایرکت‌ادمین این سرور، مثلاً https://server.example.com:2222.',
        'da_admin_username_label' => 'نام کاربری ادمین/reseller دایرکت‌ادمین',
        'da_admin_username_help' => 'یک حساب دایرکت‌ادمین (سطح admin یا reseller) برای فهرست کردن حساب‌های میزبانی و اجرای کارهای جت‌بکاپ از طریق Login Key آن.',
        'da_login_key_label' => 'Login Key دایرکت‌ادمین',
        'da_login_key_help' => 'یک Login Key ساخته‌شده در مسیر دایرکت‌ادمین -> Login Keys برای حساب بالا.',
        'da_self_username_label' => 'نام کاربری دایرکت‌ادمین خود این برنامه',
        'da_self_username_help' => 'حساب دایرکت‌ادمینی که خود برنامه woo-managment روی آن اجرا می‌شود، فقط برای دکمه «اجرای پشتیبان» در بخش مدیریت -> پشتیبان‌گیری.',
