...
<body class="bg-gray-50 min-h-screen has-bottom-nav has-sidebar">
  ...
  <header class="sticky top-0 z-30 bg-white border-b border-gray-100">
    ...
    <div class="px-4 pb-3 flex gap-2 text-sm overflow-x-auto no-scrollbar">
      ...
      <a href="/admin/sites.php" class="flex-shrink-0 whitespace-nowrap text-center rounded-xl px-4 bg-gray-900 text-white py-2 font-medium"><?php echo htmlspecialchars(t("sites")); ?></a>
  ...
  <script src="<?= asset_url('/assets/js/admin-sites.js') ?>"></script>
