...
<body class="bg-gray-50 min-h-screen has-bottom-nav has-sidebar">
  ...
  <header class="sticky top-0 z-30 bg-white border-b border-gray-100">
    ...
    <div class="px-4 pb-3 flex gap-2 text-sm">
      ...
      <a href="/admin/site-backups.php" class="flex-1 text-center rounded-xl bg-gray-900 text-white py-2 font-medium"><?php echo htmlspecialchars(t('site_backups_heading')); ?></a>
